...
class Purchased{
	...
	function search($searchKey){
		...
		// select all query
		$query = "SELECT  t.* FROM ". $this->table_name ." t  WHERE t.pid LIKE ? OR t.gid LIKE ?  OR t.uid LIKE ?  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
...
$this->message = $row['message'];
	...
	function create(){
		...
		$query ="INSERT INTO ".$this->table_name." SET gid=:gid,uid=:uid,name=:name,email=:email,message=:message";
...
$stmt->bindParam(":message", $this->message);
	...
	function update(){
		...
		// update query
		$query ="UPDATE ".$this->table_name." SET gid=:gid,uid=:uid,name=:name,email=:email,message=:message WHERE pid = :pid";
